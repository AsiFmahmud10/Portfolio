...
import { BsDownload, BsSun } from "react-icons/bs";
...
const Navbar = () => {
  ...
  return (
    <div className="w-screen gradientgreen dark:bg-gradient-to-r from-end via-blue-900 py-5 to-black shadow-lg   md:px-20 px-4 ">
